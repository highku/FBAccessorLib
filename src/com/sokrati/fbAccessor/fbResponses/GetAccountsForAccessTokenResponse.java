...
import com.sokrati.fbAccessor.fbEntities.Account;

import com.sokrati.fbRestAccessor.response.FBRestResponse;

@JsonIgnoreProperties(ignoreUnknown = true)
public class GetAccountsForAccessTokenResponse extends FBRestResponse
{
    private Account[] m_data = null;
    ...
    private void setData(Account[] data)
    {
        this.m_data = data;
    }
    ...
    public String toString()
    {
        ...
        builder.append("GetAccountsForAccessTokenResponse [m_data=");
