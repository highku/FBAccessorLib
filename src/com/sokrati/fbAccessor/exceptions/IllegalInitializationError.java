...
package com.sokrati.fbAccessor.exceptions;

public class IllegalInitializationError extends FBAccessorError
{
    public IllegalInitializationError(String message)
    {
        super(message);
    }

    public IllegalInitializationError(Throwable e)
    {
        super(e);
    }

    public IllegalInitializationError(String message, Throwable e)
    {
        super(message, e);
    }
}
