...
public class FBAccessorWarning extends Exception
{
    public FBAccessorWarning(String message)
    {
        super(message);
    }

    public FBAccessorWarning(Throwable e)
    {
        super(e);
    }

    public FBAccessorWarning(String message, Throwable e)
    {
        super(message, e);
    }
}
