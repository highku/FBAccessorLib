...
public class IllegalAccessError extends FBAccessorError
{
    public static final String METHOD_NOT_ALLOWED =
        "Method not allowed for initialization mode ";
    ...
    public IllegalAccessError(Throwable e)
    {
        super(e);
    }

    public IllegalAccessError(String message, Throwable e)
    {
        super(message, e);
    }
}
