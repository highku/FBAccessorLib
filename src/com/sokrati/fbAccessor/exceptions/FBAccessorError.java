...
abstract public class FBAccessorError extends Exception
{
    public FBAccessorError(String message)
    {
        super(message);
    }

    public FBAccessorError(Throwable e)
    {
        super(e);
    }

    public FBAccessorError(String message, Throwable e)
    {
        super(message, e);
    }
}
