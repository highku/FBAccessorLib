...
public class GetAccountsForAccessTokenRequest extends FBRestRequest
{
    private GetAccountsForAccessTokenRequest()
    {
    }

    public GetAccountsForAccessTokenRequest(String accessToken)
    {
        super(accessToken);
    }
    ...
    public String toString()
    {
        ...
        builder.append("GetAccountsForAccessTokenRequest [toString()=");
