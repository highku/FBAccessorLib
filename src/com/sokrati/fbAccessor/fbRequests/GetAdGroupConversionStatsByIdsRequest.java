...
public class GetAdGroupConversionStatsByIdsRequest extends FBBatchRequest
{
    private GetAdGroupConversionStatsByIdsRequest()
    {
    }
    
    public GetAdGroupConversionStatsByIdsRequest(String accessToken,
                                                 List<String> ids,
                                                 Date startTime,
                                                 Date endTime)
        ...
        throws FBAccessorError
    {
        ...
        if (queryParams != null)
        {
            relativeUrl += "/conversions?" + queryParams;
        }
