...
public class AuthenticationFailureError extends FBRestAccessorError
{
    public static final String FB_AUTH_EXCEPTION_TYPE = "OAuthException";
    
    public AuthenticationFailureError(String message)
    {
        super(message);
    }

    public AuthenticationFailureError(Throwable e)
    {
        super(e);
    }

    public AuthenticationFailureError(String message, Throwable e)
    {
        super(message, e);
    }
}
