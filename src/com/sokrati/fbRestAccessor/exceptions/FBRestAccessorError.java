...
abstract public class FBRestAccessorError extends Exception
{
    protected FBRestAccessorError(String message)
    {
        super(message);
    }

    protected FBRestAccessorError(Throwable e)
    {
        super(e);
    }

    protected FBRestAccessorError(String message, Throwable e)
    {
        super(message, e);
    }
}
