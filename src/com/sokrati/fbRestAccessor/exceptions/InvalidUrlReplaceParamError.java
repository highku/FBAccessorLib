...
public class InvalidUrlReplaceParamError extends FBRestAccessorError
{
    public InvalidUrlReplaceParamError(String message)
    {
        super(message);
    }

    public InvalidUrlReplaceParamError(Throwable e)
    {
        super(e);
    }

    public InvalidUrlReplaceParamError(String message, Throwable e)
    {
        super(message, e);
    }
}