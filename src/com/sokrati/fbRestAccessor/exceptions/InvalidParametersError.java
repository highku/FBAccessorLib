...
public class InvalidParametersError extends FBRestAccessorError
{
    ...
    public InvalidParametersError(Throwable e)
    {
        super(e);
    }

    public InvalidParametersError(String message, Throwable e)
    {
        super(message, e);
    }
}
